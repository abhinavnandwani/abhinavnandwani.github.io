...
def page(title, description, path, body, key='all'):
    ...
    nav = nav.replace('href="/learning/"', 'href="/learning/" class="active" aria-current="true"')
    bottom = re.search(r'<footer>.*?</body>', home, re.S).group().removesuffix('</body>')
...
<link rel="stylesheet" href="/css/style.css"><link rel="stylesheet" href="/css/learning.css">
{tracker}
